...
if (isset($_FILES['arquivo'])) {
    ...
    if ($deu_certo) {
        ...
        $mysqli->query("INSERT INTO arquivos (nome, path) VALUES ('$nameNovo', '$path')") or die($mysqli->$error);
        ...
        <div aria-live='polite' aria-atomic='true'>
            ...
            <div class='toast position-absolute top-50 start-50 translate-middle bg-dark text-white' style='z-index: 1090;'
                ...
                <div class='toast-header'>
                    ...
                    <a href ='../Imagem-unica-no-BD/index.php'>
                ...
                <form method="POST" enctype="multipart/form-data" action="">
                    <div class="input-group mb-3">
                        ...
                        <input name="name" id="name" type="text" class="form-control"
                            aria-describedby="inputGroupFileAddon04" aria-label="Name" required>
                    </div>
                    <div class="input-group mb-3">
                        <!--input multiplo e name array-->
    ...
    if (isset($resultado)) {
        /*echo "
            <script>
                ...
                setTimeout(function () {
                    window.location.href = '../Imagem-unica-no-BD/index.php';
                }, 4000);
            </script>
            ";*/
    }
